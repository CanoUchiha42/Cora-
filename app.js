...
FITNESS:()=> "Für ein Fitnessstudio kann Cora weit mehr als FAQs beantworten. Sie kann Interessenten zum Beispiel zu Mitgliedschaften, Preisen, Kursen, Öffnungszeiten, Probetraining, Leistungen und Ausstattung informieren. Besonders interessant ist die Lead-Strecke: Wenn jemand sagt, dass er ein Probetraining möchte, kann Cora gezielt nach Trainingsziel, gewünschtem Standort, bevorzugtem Zeitraum und Kontaktdaten fragen und daraus eine strukturierte Anfrage machen. Sie kann außerdem typische Einwände auffangen, etwa Fragen zu Vertragslaufzeit, Kündigung, Beiträgen oder Kursangeboten. Wenn Sie möchten, spielen wir das direkt durch: Ich kann den Interessenten simulieren und Sie sehen, wie Cora aus einem einfachen „Ich möchte ein Probetraining“ Schritt für Schritt einen qualifizierten Lead macht.",
...
function getAnswer(q){
 ...
 return "Ich kann auch freie Anfragen verarbeiten. Beschreiben Sie einfach Ihr Unternehmen, Ihre Leistungen oder ein konkretes Problem auf Ihrer Website. Beispiel: „Ich leite ein Fitnessstudio und wir bekommen viele Fragen zu Probetraining und Mitgliedschaften.“ Danach kann ich Ihnen konkret zeigen, wie Cora das Gespräch führen und daraus eine qualifizierte Anfrage entwickeln würde.";
}
